...
const (
	...
	AgentSmsText                   = "%s Код подтверждения для PaynetBNPL"
	CustomerSmsText                = `<#>PaynetBNPL: В данном сообщении представлена ссылка на публичную оферту >> https://paynet.uz/
	Указав код %s, вы принимаете ее условия.`
)
